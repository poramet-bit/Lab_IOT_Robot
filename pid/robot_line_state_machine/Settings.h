...
const int BASE_SPEED = 200;     // ความเร็วเดินหน้าปกติ — ยังไม่ได้ทดสอบจริงกับ state machine นี้ ต้องจูนใหม่
constexpr float STEERING_KP = 80; // แก้โค้งธรรมดา ปรับทีละ 5
...
const int MAX_SPEED = 240;      // เพดาน PWM ของบอร์ดนี้ (0..255)
