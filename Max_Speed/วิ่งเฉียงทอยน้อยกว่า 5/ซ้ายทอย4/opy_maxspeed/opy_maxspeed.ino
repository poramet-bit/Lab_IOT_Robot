// ============================================================================
// OPY MAX1 — LM393 closed-loop odometry (ไฟล์แยก คนละสเก็ตช์กับตัวอื่น)
// ----------------------------------------------------------------------------
...
const float LEG0_SPIN_DEG = 34.5;    const bool LEG0_SPIN_RIGHT = true;  // true หมุนขวา / false หมุนซ้าย
...
const float LEG1_SPIN_DEG = 46.5;    const bool LEG1_SPIN_RIGHT = true;  // ค่าเดิม: 89.5 หมุนขวา (ชุดแรกสุด: 563.75 ขวา)
...
// --- LEG 2 ---
const float LEG2_FORWARD_CM = 5050;                              // ค่าเดิม: 400 (ชุดแรกสุด: 1150)
const float LEG2_SPIN_DEG = 0;    const bool LEG2_SPIN_RIGHT = true; // ค่าเดิม: 0 (ชุดแรกสุด: 943.75 ซ้าย)
...
const float LEG3_SPIN_DEG = 0;    const bool LEG3_SPIN_RIGHT = true;  // ค่าเดิม: 565 หมุนขวา
