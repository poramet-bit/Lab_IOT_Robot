...
const float LEG0_SPIN_DEG = 115.5;    const bool LEG0_SPIN_RIGHT = true;  // true หมุนขวา / false หมุนซ้าย
const float LEG0_TURN_DEG = 0;    const bool LEG0_TURN_LEFT = true;   // หมุนปรับทิศเพิ่มอีกชั้น (0 = ไม่ใช้)

// --- LEG 1 ---
const float LEG1_FORWARD_CM = 140;                            // ค่าเดิม: 0 (เคยใช้ 320 / 820)
const float LEG1_SPIN_DEG = 55.5;    const bool LEG1_SPIN_RIGHT = true;  // ค่าเดิม: 89.5 หมุนขวา (ชุดแรกสุด: 563.75 ขวา)
...
// --- LEG 2 ---
const float LEG2_FORWARD_CM = 600;                              // ค่าเดิม: 400 (ชุดแรกสุด: 1150)
