...
const float LEG0_SPIN_DEG = 74.5;    const bool LEG0_SPIN_RIGHT = false;  // true หมุนขวา / false หมุนซ้าย
...
const float LEG1_SPIN_DEG = 79.5;    const bool LEG1_SPIN_RIGHT = true;  // ค่าเดิม: 89.5 หมุนขวา (ชุดแรกสุด: 563.75 ขวา)
