...
// --- LEG 1 ---
const float LEG1_FORWARD_CM = 190;                            // ค่าเดิม: 0 (เคยใช้ 320 / 820)
const float LEG1_SPIN_DEG = 85.5;    const bool LEG1_SPIN_RIGHT = true;  // ค่าเดิม: 89.5 หมุนขวา (ชุดแรกสุด: 563.75 ขวา)
...
// --- LEG 2 ---
const float LEG2_FORWARD_CM = 1000;                              // ค่าเดิม: 400 (ชุดแรกสุด: 1150)
