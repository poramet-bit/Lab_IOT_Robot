...
const float LEG0_SPIN_DEG = 109.5;    const bool LEG0_SPIN_RIGHT = false;  // true หมุนขวา / false หมุนซ้าย
...
const float LEG1_SPIN_DEG = 0;    const bool LEG1_SPIN_RIGHT = true;  // ค่าเดิม: 89.5 หมุนขวา (ชุดแรกสุด: 563.75 ขวา)
...
// --- LEG 2 ---
const float LEG2_FORWARD_CM = 0;                              // ค่าเดิม: 400 (ชุดแรกสุด: 1150)
