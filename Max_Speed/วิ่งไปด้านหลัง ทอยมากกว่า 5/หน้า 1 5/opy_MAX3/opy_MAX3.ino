// ============================================================================
// OPY MAX3 — LM393 closed-loop odometry (ไฟล์แยก คนละสเก็ตช์กับตัวอื่น)
// ----------------------------------------------------------------------------
...
const float LEG0_SPIN_DEG = 161.5;    const bool LEG0_SPIN_RIGHT = true;  // true หมุนขวา / false หมุนซ้าย
...
const float LEG1_SPIN_DEG = 64.5;    const bool LEG1_SPIN_RIGHT = false;  // ค่าเดิม: 89.5 หมุนขวา (ชุดแรกสุด: 563.75 ขวา)
...
// --- LEG 2 ---
const float LEG2_FORWARD_CM = 250;                              // ค่าเดิม: 400 (ชุดแรกสุด: 1150)
...
const float LEG3_CORRECTION3_DEG = 0;                         // ค่าเดิม: 0ccccccc
